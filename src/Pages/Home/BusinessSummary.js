...
const BusinessSummary = () => {
  return (
    <section className="my-6 w-11/12 rounded-lg mt-16 mx-auto bg-neutral p-10 text-gray-300">
      <h3 className="text-secondary  text-3xl font-semibold">
        MILLIONS PEOPLE TRUST US !
      </h3>
      <p className="mb-10 mt-2">TRY TO UNDERSTAND CUSTOMER EXPECTATION</p>
      <div className="container grid grid-cols-1 gap-6 m-4 mx-auto md:m-0 md:grid-cols-2 xl:grid-cols-3">
        <div className="flex overflow-hidden rounded-lg bg-base-100 text-gray-300">
          <div className="flex items-center justify-center px-4 bg-primary text-gray-100">
            <svg
