...
const Menufecturer = () => {
  return (
    <div class="bg-white dark:bg-gray-800 w-11/12 mx-auto mt-5 rounded-lg">
      <div class="relative px-4 py-6 overflow-hidden sm:px-6 sm:py-8 lg:p-12 xl:p-16">
        <h2 class="text-2xl text-left font-semibold font-display text-black dark:text-white sm:text-3xl">
          Contact our manufacturer Team
        </h2>
        <p class="mt-2 max-w-xl text-left text-base text-gray-400">
        ...
        <form>
          <div class="sm:flex jusitfy-start mt-6">
            <form class="flex flex-col md:flex-row w-3/4 md:w-full max-w-sm md:space-x-3 space-y-3 md:space-y-0 justify-center">
              ...
              <button
                class="flex-shrink-0 px-4 py-2 text-base font-semibold text-white bg-primary rounded-lg shadow-md hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 focus:ring-offset-purple-200"
                type="submit"
              >
                Subscribe
              </button>
        ...
        <div class="hidden lg:block absolute inset-y-0 lg:left-2/3 xl:left-1/2 right-0">
          <picture>
            <img
              class="h-full w-full object-cover maw-w-44 mx-auto"
              src={menufecturer}
              alt="shopping item"
            />
          </picture>
